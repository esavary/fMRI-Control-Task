...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/home/esavary/workspace/fMRI-Control-Task/calibration.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    calibrationTarget = visual.TargetStim(win, 
        ...
        radius=0.1, fillColor='', borderColor='black', lineWidth=2.0,
        innerRadius=0.35, innerFillColor='green', innerBorderColor='black', innerLineWidth=2.0,
